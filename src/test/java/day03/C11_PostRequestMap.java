...
*/
    ...
    public void postRequestTest() {
        ...
        assertEquals(payLoad.get("userId"),json.getInt("userId")); // not recommended way

        Map<String,Object> actualData = response.as(Map.class); // converting the dataType of the real data(json) to map(java object)
