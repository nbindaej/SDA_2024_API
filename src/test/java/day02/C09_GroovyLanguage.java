...
//        Assert that the number of 'completeds' whose ids are less than 5 is 4
        ...
        System.out.println("completed = " + completedLessThan5);
...
//        4)Print all titles whose ids are greater than 195
//        Assert that "quis eius est sint explicabo" is one of the titles whose id is less than 5
        List<String> titlesGreaterThan195 = json.getList("findAll{it.id>195}.title");
        System.out.println("titles = " + titlesGreaterThan195);

        assertTrue(titlesGreaterThan195.contains("quis eius est sint explicabo"));



//        5)Print id whose title is "quo adipisci enim quam ut ab"
//        Assert that id is 8
        Object idOfTitle = json.getList("findAll{it.title=='quo adipisci enim quam ut ab'}.id").get(0);
        System.out.println("idOfTitle = " + idOfTitle);
        assertEquals(8,idOfTitle);
